...
export function PackageModal() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-max  bg-white/40 max-h-[100vh] overflow-y-auto">
        <DialogHeader>
          ...
          <Button
            variant="ghost"
            className="absolute right-4 top-2 rounded-full bg-emerald-100 text-emerald-800 hover:bg-emerald-200 hover:text-emerald-900 z-10"
